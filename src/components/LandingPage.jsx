    ...
    <div className="relative w-full h-full">
      ...
      <div className="z-10 absolute top-0 flex  w-full justify-between px-5 mt-5 containe text-white">
        ...
        <ul className="flex unordered">
          ...
          <li className="mx-2">Rwanda</li>
          <li className="mx-2">Rwanda</li>
          <img src="../public/menu.svg" className="w-5 toggle" onClick={()=>setLinks(!links)}/>
        </ul>
      </div>

      {links && <div className="bg-slate-200 z-10 absolute top-0 right-5 mt-16">
      ...
      <div className='top-0 absolute w-full flex justify-center items-center h-full '>
        <div className='text-white'>
          ...
          <h2 className=''>The happiest and safesty country in <br/> <span className='flex justify-center'>the world</span></h2>
        </div>
      </div>
