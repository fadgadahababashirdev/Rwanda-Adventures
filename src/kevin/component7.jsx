...
export default () => {
  ...
  return (
    <div className="h-screen mt-4 ml-10 latest" id="Component7">
      <div className="flex flex-col lg:flex-row">
        ...
        <div className="lg:w-1/2 px-10">
          <p className="pt-10">
            At Explorer Rwanda, our team is the heart and soul of everything we
            do. Comprised of passionate individuals with diverse backgrounds and
            expertise, we come together to achieve one common goal: delivering
